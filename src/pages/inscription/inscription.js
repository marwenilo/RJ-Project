  ...
  <InscriptionWrapper>
    ...
    <div className="title-container">
      <div className="s-container">
        ...
        <input type="text" className="ss-titre" placeholder="First Name" />
        <p className="paragraphe">Last Name</p>
        <input type="text" className="ss-titre" placeholder="Last Name" />
        ...
        <input type="text" className="ss-titre" placeholder="Numero " />
