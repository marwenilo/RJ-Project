          ...
          <div className="homeContainer">
            <div className="intro">
              ...
              <div className="introDescri">
                <p>
                  If you want to avoid spam, scams, and duplicate job listings,
                  <strong className="logoRight">righ</strong>
                  <strong className="logoJob">Job</strong>
                  is the job site for you.
                  <strong className="logoRight">righ</strong>
                  <strong className="logoJob">Job</strong>
                  only posts jobs provided on company websites, furnishing
                  applicants with often unadvertised jobs. Because the jobs come
                  directly from company sites, you can be sure they are current
                  openings.
                </p>
              </div>
            </div>
            <div className="intro aaa">
              ...
              <div className="introDescri">
                <p>
                  <strong className="logoRight">righ</strong>
                  <strong className="logoJob">Job</strong>
                  is the expert in matching jobs seekers with company using
                  machine learning to know which skills are related{" "}
                </p>
              </div>
            ...
            <div className="storyContainer">
              ...
              <div className="stories">
                <div className="story">
                  ...
                  <h3>
                    Finding a new job is tedious and stressful. Working with
                    rightJob meant multiple companies that were a good fit were
                    looking to hire me.
                  </h3>
                </div>
                <div className="story">
                  ...
                  <h3>
                    With rightJob, companies were highly responsive and moved
                    through the process very quickly. I never had to wait more
                    than a couple days to hear back from anyone.
                  </h3>
                </div>
                <div className="story">
                  ...
                  <h4>Accountant</h4>
                  <h3>
                    I can do everything on my own schedule. From picking out
                    interview time slots to selecting only the companies I want
                    to interview with, this is what recruiting should look like.
                  </h3>
                </div>
              </div>
            </div>
